...
The reason why it is blocked is that the address of `thisenv` is `0x802008`, which is located in `Program Data & Heap`(see `inc/memlayout.h`), this this variable is shared between parent and child. 
